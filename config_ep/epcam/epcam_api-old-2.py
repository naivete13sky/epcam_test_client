...
def drill2file(job, step, layer,path,isMetric,number_format_l=2,number_format_r=6,
                    zeroes=1,unit=0,x_scale=1,y_scale=1,x_anchor=0,y_anchor=0, manufacator = '', tools_order = []):
    data = {
        'func': 'DRILL2FILE',
        'paras': {
            'job': job,
...
def rout2file(job, step, layer,path,number_format_l=2,number_format_r=6,
                    zeroes=1,unit=0,x_scale=1,y_scale=1,x_anchor=0,y_anchor=0, partial_order = 0
